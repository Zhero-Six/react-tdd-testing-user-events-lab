...
// Existing portfolio tests (unchanged)
...
test("a message is displayed when the user clicks the Submit button", async () => {
  ...
  const message = screen.getByText(/thanks, john doe/i);
  expect(message).toBeInTheDocument();
  // Bonus: Check for interests in the message
  expect(message).toHaveTextContent(/technology/i);
});